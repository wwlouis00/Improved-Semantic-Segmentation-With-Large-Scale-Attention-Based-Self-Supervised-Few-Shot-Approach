...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/root/Work/m11107s08/Annotation-Free-Fewshot/dataset(2)')
    parser.add_argument('--benchmark', type=str, default='fss',choices=['fss','pascal','coco'])
    parser.add_argument('--logpath', type=str, default='')
    parser.add_argument('--bsz', type=int, default=20)
    parser.add_argument('--nworker', type=int, default=0)
    # parser.add_argument('--load', type=str, default='./logs/fss_weightsnew.pt')
    # pascal 
    # parser.add_argument('--load', type=str, default='/root/Work/m11107s08/Annotation-Free-Fewshot/Pretrained/pascal/exp11.log/best_model.pt')
    # pascal lora 
    # parser.add_argument('--load', type=str, default='/root/Work/m11107s08/Annotation-Free-Fewshot/logs/20240706_04:10:26.log/best_model.pt')
    
    # FSS
    parser.add_argument('--load', type=str, default='/root/Work/m11107s08/Annotation-Free-Fewshot/Pretrained/fss/exp2.log/best_model.pt')
    
    # FSS_lora
    
    # parser.add_argument('--load', type=str, default='/root/Work/m11107s08/Annotation-Free-Fewshot/lora_result/20240630_07:39:25.log/best_model.pt')
    ...
    Logger.info('====================測試完成(Finished Testing)====================')
